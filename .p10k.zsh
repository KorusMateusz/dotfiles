# Generated by Powerlevel10k configuration wizard on 2019-12-07 at 16:40 CET.
...
# 2 lines, solid, left frame, lightest, sparse, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%244F╰─ %F{001}λ%f'
  ...
  function prompt_sdk() {
    if (( ${+CDE_SDK_VERSION} )); then
      p10k segment -t $CDE_SDK_VERSION
    fi
  }

  POWERLEVEL9K_SDK_BACKGROUND=green
